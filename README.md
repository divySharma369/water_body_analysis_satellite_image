...
All the code for training the model and exporting to ONNX format is present in the [notebook](notebooks) folder. The [app.py](app.py) file contains the code for deploying the model using Gradio.
